            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="products-list1 categry-list">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="products.php">
                                                    <img class="default-img" src="assets/imgs/shop/p1.jpg" alt="" />
                                                   
                                                </a>
                                            </div>
                                           
                                        </div>
                                        <div class="product-content-wrap category-info">
                                            <h2><a href="products.php">TSHIRTS</a></h2>                                        
                                            <h4>40-70% OFF</h4>                                       
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-6">
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="products.php">
                                                    <img class="default-img" src="assets/imgs/shop/p2.jpg" alt="" />
                                        ...
                                        <div class="product-content-wrap category-info">
                                            <h2><a href="products.php">Bag print</a></h2>                                        
                                            <h4>40-70% OFF</h4>                                       
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-6">
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="products.php">
                                                    <img class="default-img" src="assets/imgs/shop/p3.jpg" alt="" />
                                        ...
                                        <div class="product-content-wrap category-info">
                                            <h2><a href="products.php">Gift Pack</a></h2>                                        
                                            <h4>40-70% OFF</h4>                                       
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-6">
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="products.php">
                                                    <img class="default-img" src="assets/imgs/shop/p4.jpg" alt="" />
                                        ...
                                        <div class="product-content-wrap category-info">
                                            <h2><a href="products.php">Paper cup</a></h2>                                        
                                            <h4>40-70% OFF</h4>                                       
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-6">
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="products.php">
                                                    <img class="default-img" src="assets/imgs/shop/p5.jpg" alt="" />
                                        ...
                                        <div class="product-content-wrap category-info">
                                            <h2><a href="products.php">Brochure</a></h2>                                        
                                            <h4>40-70% OFF</h4>                                       
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-6">
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="products.php">
                                                    <img class="default-img" src="assets/imgs/shop/p6.jpg" alt="" />
                                        ...
                                        <div class="product-content-wrap category-info">
                                            <h2><a href="products.php">HOODIES</a></h2>                                        
                                            <h4>40-70% OFF</h4>                                       
                                        </div>
                                    </div>
                                </div>
